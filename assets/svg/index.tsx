...
export const AvatarUpload: React.FC<Props> = ({ className, ...rest }) => {
  return (
    <svg
      width={80}
      height={80}
...
export const XButton: React.FC<Props> = ({ className, ...rest }) => {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
export const CloseFilledIcon: React.FC<Props> = (props) => (
  <svg
    aria-hidden="true"
    focusable="false"
    height="1em"
...
export const ArrowBack: React.FC<Props> = (props) => (
  <svg
    aria-hidden="true"
    role="img"
    width="16"
